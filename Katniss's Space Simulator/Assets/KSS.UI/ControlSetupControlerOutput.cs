...
namespace KSS.UI
{
    public class ControlSetupControlerOutput : MonoBehaviour
    {
        ...
        internal static ControlSetupControlerOutput Create( ControlSetupWindowNode node, float verticalOffset, Control.Control control, NamedControlAttribute attr )
        {
            ...
            ControlSetupControlerOutput output = icon.gameObject.AddComponent<ControlSetupControlerOutput>();
            output._node = node;
