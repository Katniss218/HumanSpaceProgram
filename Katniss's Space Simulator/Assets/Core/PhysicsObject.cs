...
namespace KatnisssSpaceSimulator.Core
{
    ...
    public class PhysicsObject : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            Vector3Dbl toBody = cb.AIRFPosition - SceneReferenceFrameManager.SceneReferenceFrame.TransformPosition( this.transform.position );

            Vector3 toBodyWorldSpace = SceneReferenceFrameManager.SceneReferenceFrame.InverseTransformPosition( toBody );
