...
namespace UnityPlus.Serialization
{
    public static class Persistent_Delegate
    {
        ...
        internal static SerializedData GetData( Delegate delegateObj, IReverseReferenceMap s )
        {
            if( delegateObj == null )
                return null;
        ...
        /// </remarks>
        [MethodImpl( MethodImplOptions.AggressiveInlining )]
        internal static Delegate ToDelegate( SerializedData data, IForwardReferenceMap l )
        {
            if( data == null )
                return null;
