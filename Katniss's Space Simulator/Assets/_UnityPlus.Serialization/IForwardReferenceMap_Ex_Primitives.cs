...
namespace UnityPlus.Serialization
{
    public static class IForwardReferenceMap_Ex_Primitives
    {
        ...
        public static Vector2 ReadVector2( this IForwardReferenceMap _, SerializedData json )
        {
            return new Vector2( (float)json[0], (float)json[1] );
        }

        [MethodImpl( MethodImplOptions.AggressiveInlining )]
        public static Vector2Int ReadVector2Int( this IForwardReferenceMap _, SerializedData json )
        {
            return new Vector2Int( (int)json[0], (int)json[1] );
        }

        [MethodImpl( MethodImplOptions.AggressiveInlining )]
        public static Vector3 ReadVector3( this IForwardReferenceMap _, SerializedData json )
        {
            return new Vector3( (float)json[0], (float)json[1], (float)json[2] );
        }
        
        [MethodImpl( MethodImplOptions.AggressiveInlining )]
        public static Vector3Dbl ReadVector3Dbl( this IForwardReferenceMap _, SerializedData json )
        {
            return new Vector3Dbl( (double)json[0], (double)json[1], (double)json[2] );
        }

        [MethodImpl( MethodImplOptions.AggressiveInlining )]
        public static Vector3Int ReadVector3Int( this IForwardReferenceMap _, SerializedData json )
        {
            return new Vector3Int( (int)json[0], (int)json[1], (int)json[2] );
        }

        [MethodImpl( MethodImplOptions.AggressiveInlining )]
        public static Vector4 ReadVector4( this IForwardReferenceMap _, SerializedData json )
        {
            return new Vector4( (float)json[0], (float)json[1], (float)json[2], (float)json[3] );
        }

        [MethodImpl( MethodImplOptions.AggressiveInlining )]
        public static Quaternion ReadQuaternion( this IForwardReferenceMap _, SerializedData json )
        {
            return new Quaternion( (float)json[0], (float)json[1], (float)json[2], (float)json[3] );
        }
        
        [MethodImpl( MethodImplOptions.AggressiveInlining )]
        public static QuaternionDbl ReadQuaternionDbl( this IForwardReferenceMap _, SerializedData json )
        {
        ...
        /// </summary>
        [MethodImpl( MethodImplOptions.AggressiveInlining )]
        public static Guid ReadGuid( this IForwardReferenceMap _, SerializedData json )
        {
        ...
        [MethodImpl( MethodImplOptions.AggressiveInlining )]
        public static Type ReadType( this IForwardReferenceMap _, SerializedData json )
        {
