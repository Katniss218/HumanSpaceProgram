...
namespace UnityPlus.Serialization
{
    public static class Persistent_Delegate
    {
        ...
        /// </remarks>
        [MethodImpl( MethodImplOptions.AggressiveInlining )]
        public static Delegate ToDelegate( this SerializedData data, IForwardReferenceMap l )
        {
            if( data == null )
                return null;
        ...
        private static Delegate ReadSingleDelegate( SerializedData data, IForwardReferenceMap l )
        {
            ...
            IEnumerable<Type> parameters = ((SerializedArray)data["method"]["parameters"]).Select( p => p.ToType() );
