...
namespace HSP.Trajectories
{
    ...
    public class TrajectoryPhysicsObject : MonoBehaviour, IPhysicsObject
    {
        ...
        void Awake()
        {
            ...
            {
                Debug.LogWarning( $"Tried to add a {nameof( TrajectoryPhysicsObject )} to a game object that already has a {nameof( IPhysicsObject )}. This is not allowed. Remove the previous physics object first." );
                Destroy( this );
                return;
            }
        ...
        [MapsInheritingFrom( typeof( TrajectoryPhysicsObject ) )]
        public static SerializationMapping FreePhysicsObjectMapping()
        {
            return new MemberwiseSerializationMapping<TrajectoryPhysicsObject>()
            {
                ("mass", new Member<TrajectoryPhysicsObject, float>( o => o.Mass )),
                ("local_center_of_mass", new Member<TrajectoryPhysicsObject, Vector3>( o => o.LocalCenterOfMass )),

                ("DO_NOT_TOUCH", new Member<TrajectoryPhysicsObject, bool>( o => false, (o, value) => o._rb.isKinematic = false)), // TODO - isKinematic member is a hack.

                ("velocity", new Member<TrajectoryPhysicsObject, Vector3>( o => o.Velocity )),
                ("angular_velocity", new Member<TrajectoryPhysicsObject, Vector3>( o => o.AngularVelocity ))
            };
        }
    }
}