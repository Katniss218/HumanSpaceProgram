...
{
    /// <summary>
    /// The base class that all attachment nodes must inherit from. <br/>
    /// This class is used to define the behavior shared across all attachment nodes; like snapping, size, etc.
    /// </summary>
    public abstract class FAttachNode : FComponent
    {
        /// <summary>
