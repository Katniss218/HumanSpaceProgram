...
//            // Act
//            TrajectoryStateVector state = sut.GetCurrentState();
...
//            TrajectoryStateVector state = new TrajectoryStateVector(
...
//            sut.ParentBody = parent;
//            TrajectoryStateVector origState = new TrajectoryStateVector( new Vector3Dbl( -1000000, 0, 0 ), new Vector3Dbl( 100, 0, 0 ), Vector3Dbl.zero, 1 );
...
//            KeplerianOrbit sut = new KeplerianOrbit( 0, null, 0, 0, 0, 0, 0, 0, 1 );
//            sut.ParentBody = parent;
//            TrajectoryStateVector origState = new TrajectoryStateVector( new Vector3Dbl( -1000000, 0, 0 ), Vector3Dbl.zero, Vector3Dbl.zero, 1 );
//            sut.SetCurrentState( origState );
...
//            TrajectoryStateVector source = new TrajectoryStateVector( new Vector3Dbl( rx, ry, rz ), new Vector3Dbl( vx, vy, vz ), Vector3Dbl.zero, 5.97e24 );
//            target.SetCurrentState( source );

//            // Act
//            TrajectoryStateVector targetState = target.GetCurrentState();
...
//            // Act
//            TrajectoryStateVector state = source.GetCurrentState();
...
//        {
//            FixedOrbit parent = new FixedOrbit( 0, Vector3Dbl.zero, QuaternionDbl.identity, 1.989e30 );
//            TrajectoryStateVector state = new TrajectoryStateVector( new Vector3Dbl( rx, ry, rz ), new Vector3Dbl( vx, vy, vz ), Vector3Dbl.zero, 5.97e24 );
...
//            TrajectoryStateVector[] immovingSun = new TrajectoryStateVector[] { parent.GetCurrentState() };
...
//            TrajectoryStateVector state1 = new TrajectoryStateVector( new Vector3Dbl( 149999999990.673, 1673092.43402889, 0 ), new Vector3Dbl( -0.33182054440848, 29749.1548977251, 0 ), Vector3Dbl.zero, 5.97e24 );
//            TrajectoryStateVector state2 = new TrajectoryStateVector( new Vector3Dbl( 149999999990.666, 1673687.41711355, 0 ), new Vector3Dbl( -0.332641608997619, 29712.5494536955, 0 ), Vector3Dbl.zero, 5.97e24 );
//            kepler1.SetCurrentState( state1 );
//            kepler2.SetCurrentState( state2 );

//            var state1back = kepler1.GetCurrentState();

//            kepler1.Step( new TrajectoryStateVector[] { parent.GetCurrentState() }, 0.02 );
