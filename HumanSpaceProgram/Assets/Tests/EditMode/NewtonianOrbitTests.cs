...
//            sut2.SetCurrentState( new TrajectoryStateVector( new Vector3Dbl( 6_371_000.0 + 200_000, 0, 0 ), new Vector3Dbl( 0, 8500, 0 ), Vector3Dbl.zero, 1 ) );
            
//            KeplerianOrbit sut3 = new KeplerianOrbit( 0, null, 0, 0, 0, 0, 0, 0, 1 );
//            sut3.ParentBody = parent;
//            sut3.SetCurrentState( new TrajectoryStateVector( new Vector3Dbl( 6_371_000.0 + 200_000, 0, 0 ), new Vector3Dbl( 0, 8500, 0 ), Vector3Dbl.zero, 1 ) );
...
//            TrajectoryStateVector state = sut.GetCurrentState();
//            TrajectoryStateVector state2 = sut2.GetCurrentState();
//            TrajectoryStateVector state3 = sut3.GetCurrentState();
