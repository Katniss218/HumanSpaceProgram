...
namespace HSP.SceneManagement
{
    ...
    /// </remarks>
    /// <typeparam name="T">The derived scene type.</typeparam>
    public abstract class HSPScene<T, TLoadData> : SingletonMonoBehaviour<T>, IHSPScene<TLoadData> where T : HSPScene<T, TLoadData>
    {
        /// <summary>
        /// Override this to tell the loader to load a custom scene (included in an asset bundle or in the project).
        /// </summary>
        ...
        /// Runs right after the scene is loaded.
        /// </summary>
        protected abstract void OnLoad( TLoadData loadData );
        /// <summary>
        /// Runs right before the scene is unloaded.
        /// </summary>
        protected abstract void OnUnload();
        ...
        public void _onload( TLoadData loadData )
        {
