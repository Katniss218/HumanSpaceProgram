...
//        ITrajectoryIntegrator _parentBody;
//        /// <summary>
//        /// Gets or sets the parent trajectory directly. <br/>
//        /// May be null.
//        /// </summary>
//        public ITrajectoryIntegrator ParentBody
//        {
//            get
//            {
...
//        {
//            TrajectoryStateVector parentState = ParentBody?.GetCurrentState() ?? new TrajectoryStateVector();
...
//            return new TrajectoryStateVector( bodyCentricPosition + parentState.AbsolutePosition, velocity + parentState.AbsoluteVelocity, acceleration + parentState.AbsoluteAcceleration, Mass );
//        }
