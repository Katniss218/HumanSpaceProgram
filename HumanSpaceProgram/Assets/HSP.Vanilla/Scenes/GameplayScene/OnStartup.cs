...
namespace HSP.Vanilla.Scenes.GameplayScene
{
    public class OnStartup : MonoBehaviour
    {
        ...
        [HSPEventListener( HSPEvent_SCENELOAD_GAMEPLAY.ID, UNPAUSE )]
        ...
        [HSPEventListener( HSPEvent_SCENELOAD_GAMEPLAY.ID, ADD_TIMESCALE_INPUT_CONTROLLER )]
        ...
        [HSPEventListener( HSPEvent_SCENELOAD_GAMEPLAY.ID, ADD_GAMEPLAY_SCENE_TOOL_MANAGER )]
        ...
        [HSPEventListener( HSPEvent_SCENELOAD_GAMEPLAY.ID, ADD_SCENE_REFERENCE_FRAME_MANAGER )]
        ...
        [HSPEventListener( HSPEvent_SCENELOAD_GAMEPLAY.ID, ADD_ESCAPE_INPUT_CONTROLLER )]
        ...
        [HSPEventListener( HSPEvent_SCENELOAD_GAMEPLAY.ID, ADD_TRAJECTORY_MANAGER )]
