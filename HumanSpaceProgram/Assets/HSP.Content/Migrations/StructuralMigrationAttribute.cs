...
namespace HSP.Content.Migrations
{
    ...
    public class StructuralMigrationAttribute : Attribute
    {
        /// <summary>
        ...
        public static bool IsValidMethodSignature( MethodInfo method )
        {
            ...
            if( parameters[0].ParameterType != typeof( IMigrationContext ) )
                return false;
        ...
        public StructuralMigrationAttribute( string modId, string fromVersion, string toVersion )
        {
