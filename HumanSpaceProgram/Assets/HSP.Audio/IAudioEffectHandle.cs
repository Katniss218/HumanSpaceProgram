...
namespace HSP.Audio
{
    ...
    public readonly struct AudioEffectHandle
    {
        ...
        private readonly AudioSourcePoolItem _poolItem;

        internal AudioEffectHandle( AudioSourcePoolItem poolItem )
        {
            _poolItem = poolItem;
        ...
        private void EnsureValid()
        {
            ...
            if( _poolItem == null || _version != _poolItem.version )
                throw new ObjectDisposedException( nameof( AudioEffectHandle ), "The pool item backing the audio handle has been disposed or reused and is no longer valid for this handle." );
        }
