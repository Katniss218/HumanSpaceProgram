...
{
    public interface IMessageEventData
    {
    ...
    public sealed class TimelineLoadEventData : IMessageEventData
    {
        ...
        public TimelineLoadEventData( ScenarioMetadata scenario, TimelineMetadata timeline, SaveMetadata save )
        {
