...
namespace UnityEngine
{
    public struct Matrix3x3
    {
        ...
        public Matrix3x3 inverse => Invert();
        ...
        public Vector3 GetRow( int row )
        {
            return row switch
            {
                ...
                _ => throw new IndexOutOfRangeException( "Row index must be 0..2" ),
            };
        }
        ...
        public Vector3 GetColumn( int col )
        {
            return col switch
            {
                ...
                _ => throw new IndexOutOfRangeException( "Column index must be 0..2" ),
            };
        }
        ...
        /// <summary>
        /// Try to invert the matrix. Returns false when determinant is (near) zero.
        /// </summary>
        [MethodImpl( MethodImplOptions.AggressiveInlining )]
        public bool TryInvert( out Matrix3x3 inverse, float epsilon = 1e-6f )
        {
            ...
            {
                inverse = identity;
                return false; // Non-invertible (singular matrix)
            }
        ...
        /// <summary>
        /// Invert the matrix, throws InvalidOperationException if singular.
        /// </summary>
        [MethodImpl( MethodImplOptions.AggressiveInlining )]
        public Matrix3x3 Invert( float epsilon = 1e-6f )
        {
            if( TryInvert( out Matrix3x3 inv, epsilon ) )
                return inv;
