...
{
    public sealed class UIConsoleCanvas : UICanvas
    {


        public static new UIConsoleCanvas Create( Scene scene, string id )
        {
            var x = Create<UIConsoleCanvas>( scene, id );

            x.canvas.renderMode = RenderMode.ScreenSpaceOverlay;
            x.canvas.pixelPerfect = false;
            x.canvas.sortingOrder = 99;
