...
{
    public sealed class UICursorCanvas : UICanvas
    {


        public static new UICursorCanvas Create( Scene scene, string id )
        {
            var x = Create<UICursorCanvas>( scene, id );

            x.canvas.renderMode = RenderMode.ScreenSpaceOverlay;
            x.canvas.pixelPerfect = false;
            x.canvas.sortingOrder = 40;
